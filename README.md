# awesome-strava: A curated list of awesome Strava tools & resources
...
* [Explorer Helper](https://play.google.com/store/apps/details?id=ru.anisart.vv&hl=en) - Gets your VeloViewer/Squadrats/StatsHunters tiles and tracks and shows it on map (Android)
...
* [Strava map switcher – JS Script](https://github.com/gr4v1ty69/strava-scripts/blob/main/strava-custom-maps.user.js)
